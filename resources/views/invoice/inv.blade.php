...
.nav-tabs .nav-link.active, .nav-tabs .nav-item.show .nav-link {
  ...
  border-color : #002900 #002900 #002900;
}
   ...
   <section class="card invoice-page">
    <div id="invoice-template" class="card-body">
        ...
        <div id="invoice-company-details" class="row">
            ...
            <div class="col-sm-6 col-12 text-right" style="margin-left: 50% !important">
                <h1>Invoice</h1>
        ...
        <div id="invoice-company-details" class="row pt-1">
            <div class="col-sm-6 col-12 text-left">
                <h5>Recipient</h5>
				<p>Peter Stark<br/>
				8577 West West Drive<br/>
				Holbrook, NY<br/>
				90001<br/>
				peter@mail.com<br/>
				+91 988 888 8888</p>
            ...
            <div class="col-sm-6 col-12 text-right" style="margin-left: 50% !important">
				...
				<p>9 N. Sherwood Court<br/>
				Elyria, OH<br/>
				94203<br/>
				hello@pixinvent.net<br/>
				+91 999 999 9999</p>
            </div>
        </div>
        <!--/ Invoice Recipient Details -->
        ...
        <div id="invoice-items-details" class="invoice-items-table" style="margin-top: -150px !important">
            <div class="row">
