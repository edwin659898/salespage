      ...
      <div class="card mt-5 px-3 py-4">
        ...
        <div class="media mt-3 pl-2">
            ...
            {{-- <p class="btn btn-primary btn-lg btn-block" type="submit">Pay Now {{ $total_amount }}</p> --}}
                  ...
                  <p>Kindly pay Cash <span class="ti-lock" style="color: #c43b19">${{ $total_amount }}</span> on delivary.<br> For any enquiry, Kindly call this number.</p> <p>Thank You for Shoping With us.</p>
                </div>
